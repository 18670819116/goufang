 ...
 * @Description: presenter of IndexFragment
...
public class IndexPresenter implements IndexContract.IndexContractPresenter{
    ...
    @Inject
    public IndexPresenter(@NonNull HttpAPIWrapper httpAPIWrapper, @NonNull IndexContract.View view, IndexFragment fragment) {
        mView = view;
