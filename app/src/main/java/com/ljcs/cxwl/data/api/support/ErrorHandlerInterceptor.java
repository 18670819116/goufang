...
//        com.orhanobut.logger.Logger..i("网络请求的网址为:" + request.toString());
        long contentLength = responseBody.contentLength();
        com.orhanobut.logger.Logger.e("请求的地址为：" + request.url());
...
//        if(!HttpHeader.hasBody(response)){
            ...
            if (!isPlaintext(buffer)) {
                com.orhanobut.logger.Logger.i("<-- END HTTP (binary " + buffer.size() + "-byte body omitted)");
                return response;
            }
